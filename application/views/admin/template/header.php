...
<body class="hold-transition skin-red-light" style="background: #aaa;" >
<!-- Site wrapper -->
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= base_url() ?>assets/index2.html" class="logo">
      ...
      <span class="logo-mini"><b>SMK BISA</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><h4><b><?= $biodata->nama_sekolah ?></b></h4></span>
