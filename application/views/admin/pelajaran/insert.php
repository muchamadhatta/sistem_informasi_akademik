        ...
        <form role="form" action="" method="post" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group <?= form_error('kode_pelajaran') ? 'has-error' : '' ?>">
              <label for="nama_pelajaran"> Kode Pelajaran</label>
              <input type="text" name="kode_pelajaran" class="form-control" id="nama_pelajaran" placeholder="Enter Kode Pelajaran"  value="<?= set_value('kode_pelajaran') ?>" >
            ...
            <div class="form-group <?= form_error('jam') ? 'has-error' : '' ?>">
              ...
              <input type="text" name="jam" class="form-control" id="jam" placeholder="Enter Jam"  value="<?= set_value('jam') ?>" >
