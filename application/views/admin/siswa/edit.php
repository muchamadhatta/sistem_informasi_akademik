        ...
        <form role="form" action="" method="post" enctype="multipart/form-data">
          <div class="box-body">
              ...
              <input type="text" name="nama_siswa" class="form-control" id="nama_siswa" placeholder="Enter Nama Siswa" value="<?= set_value('nama_siswa') ? set_value('nama_siswa') : $siswa->nama_siswa ?>">
               <?= form_error('nama_siswa', '<i class="text-danger">', '</i>') ?>
                         ...
                         <div class="form-group <?= form_error('tahun_ajaran') ? 'has-error' : '' ?>">
                          ...
                          <input type="text" name="tahun_ajaran" class="form-control" id="tahun_ajaran" placeholder="Enter Tahun Ajaran" value="<?= set_value('tahun_ajaran') ? set_value('tahun_ajaran') : $siswa->tahun_ajaran ?>">
            ...
            <div class="form-group <?= form_error('no_telepon') ? 'has-error' : '' ?>">
              ...
              <input type="text" name="no_telepon" class="form-control" id="no_telepon" placeholder="Enter No Telepon" value="<?= set_value('no_telepon') ? set_value('no_telepon') : $siswa->no_telepon ?>">
