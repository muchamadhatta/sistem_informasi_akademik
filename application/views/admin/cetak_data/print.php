...
<body>
	...
	<a href="<?= base_url() ?>admin/cetak_data" class="btn btn-default"><i class="fa fa-reply"></i> Kembali</a>
		...
		<div class="row" style="padding-top: 15px">
			...
			<table class="table table-striped">
				...
				<tr>
					<th width="30%">1.	Nama Siswa (Lengkap)</th>
					<th width="30%"> : </th>
			...
			<!-- <div style="min-height: 1400px;">
				<table width="384">
					...
					<tr>
						...
						<td style="width: 184px;">: <b><?=$siswa->nama_kelas ?></td>
					</tr>
					<tr>
