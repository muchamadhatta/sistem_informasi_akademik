        ...
        <form role="form" action="" method="post" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group <?= form_error('keterangan') ? 'has-error' : '' ?>">
              ...
              <input type="text" name="keterangan" class="form-control" id="keterangan" placeholder="Enter Keterangan"  value="<?= set_value('keterangan') ? set_value('keterangan') : $kelas->keterangan ?>">
              <?= form_error('keterangan', '<small><i class="text-danger">', '</i></small>') ?>
            </div><br>
            <div class="form-group <?= form_error('wali_kelas') ? 'has-error' : '' ?>">
              <label for="wali_kelas"> Wali Kelas</label>
              <input type="text" name="wali_kelas" class="form-control" id="wali_kelas" placeholder="Enter Wali Kelas"  value="<?= set_value('wali_kelas') ? set_value('wali_kelas') : $kelas->wali_kelas ?>">
              <?= form_error('wali_kelas', '<small><i class="text-danger">', '</i></small>') ?>
            </div><br>
            <div class="form-group <?= form_error('ruang') ? 'has-error' : '' ?>">
              <label for="ruang"> Ruang</label>
              <input type="text" name="ruang" class="form-control" id="ruang" placeholder="Enter Ruang"  value="<?= set_value('ruang') ? set_value('ruang') : $kelas->ruang ?>">
