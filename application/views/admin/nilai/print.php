...
<body>
	<a href="<?= base_url() ?>admin/nilai" class="btn btn-default"><i class="fa fa-reply"></i> Kembali</a>
<div class="container">
...
<thead>
     <tr>
          <th rowspan="3" width="5%" class="text-center">&nbsp; Mata Pelajaran</th>
          <th colspan="8" class="text-center">&nbsp;Semester <?= $semester ?>
          </th>
        </tr>
        <tr>
   ...
   <?php $i=1; $rata=0; foreach ($dataNilai->result() as $nilai):  ?>
      ...
      <?php $nilairatarata = (($nilai->tugas_1 + $nilai->tugas_2 + $nilai->tugas_3) + $nilai->uts + $nilai->uas) / 5  ;  ?>
        ...
        <tr>
          ...
          <td class="text-center"><?= $nilai->kkm ?></td>
					<td class="text-center"><?= $nilai->tugas_1 ?></td>
          <td class="text-center"><?= $nilai->tugas_2 ?></td>
          <td class="text-center"><?= $nilai->tugas_3 ?></td>
    ...
    <tfoot>
     ...
     <td colspan="10" style="padding: 10px;">
              ...
              <textarea name="catatan_<?= $semester ?>" cols="100" rows="4" ><?= $semester == 1 ? $siswa->catatan_1 : $siswa->catatan_2 ?></textarea>
             </td>
               <tr>
               <td colspan="10" style="padding: 10px;">
              <label for="keputusan">Keputusan :</label><br>
              <textarea name="keputusan_<?= $semester ?>" cols="100" rows="4" ><?= $semester == 1 ? $siswa->keputusan_1 : $siswa->keputusan_2 ?></textarea>
              </td>
       <tr>
       <table class="table"> 
